...
public:
  ...
  void setVertexShader(std::string text);
  void setFragShader(std::string text);
  virtual ~QtOSGWidget(){}
  ...
  Q_OBJECT
public slots:
    void executeShader(std::string vertexShader, std::string fragmentShader, std::string geomShader);
protected:
